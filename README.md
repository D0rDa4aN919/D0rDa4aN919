...
- [SmtimesIWndr/gdid-reversal](https://github.com/SmtimesIWndr/gdid-reversal) -  - 684 stars
- [swisskyrepo/PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) - A list of useful payloads and bypass for Web Application Security and Pentest/CTF - 79555 stars
- [entra1337/DirtyClone](https://github.com/entra1337/DirtyClone) - Python Proof of Concept for DirtyClone (CVE-2026-43503) - Linux kernel LPE via page-cache corruption - 24 stars
...
- [Hexastrike/PyrsistenceSniper](https://github.com/Hexastrike/PyrsistenceSniper) - We took PersistenceSniper, merged it with Python, and misspelled it on purpose. Meet PyrsistenceSniper. - 241 stars
